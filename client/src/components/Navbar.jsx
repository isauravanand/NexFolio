...
const Navbar = () => {
    ...
    // Custom class for a deeper, more refined shadow glow
    // This creates a soft, purple-tinted glow on the dark background
    const shadowGlow = "shadow-[0_0_50px_rgba(109,40,217,0.3),_0_0_15px_rgba(255,255,255,0.05)]";

    return (
        <>
            {/* Custom animation definition (used for the floating bubble, removed but kept placeholder style tag) */}
            <style>
                {`
            ...
            {/* Navbar Container: Darker background, stronger blur, and custom glow */}
            <div className={`
            ...
            `}>
                ...
                {/* Logo: Bolder font and simple hover color change */}
                ...
                <div className="hidden md:flex items-center space-x-8">
                    ...
                    {/* SIGN IN BUTTON (Outlined, Subtle Hover) */}
                    {authenticated ? (
                        <button
                        ...
                        >
                            ...
                            <span className="relative overflow-hidden"> {/* FIXED: Added overflow-hidden to clip the shine */}
                                Sign In
                    ...
                    {/* GET STARTED (Primary Gradient Button - Rounded Full) */}
                    <button
            ...
            {/* Mobile Dropdown Menu: Uses darker background for contrast */}
            <div
                className={`
